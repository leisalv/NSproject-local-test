...
myeeg_in = pop_select(myeeg_scored, 'channel', params.inchans);  
...
myeeg_epWk = pop_epoch(myeeg_asr, {'Wake'}, [0  30], 'epochinfo', 'yes');
pop_saveset(myeeg_epWk, 'filename', 'DA_wakeEpNAP_PREP.set', 'filepath', myoutdata, 'version','7.3');

myeeg_epN1 = pop_epoch(myeeg_asr, {'NREM1'}, [0  30], 'epochinfo', 'yes');
pop_saveset(myeeg_epN1, 'filename', 'DA_nrem1EpNAP_PREP.set', 'filepath', myoutdata, 'version','7.3');
