...
myeeg_prep_N1 = pop_loadset(fullfile(derivpath, 'NS_nap_preproc_v9', 'prep_data', 'DA_nrem1EpNAP_PREP.set'));
myeeg_prep_N1 = eeg_checkset(myeeg_prep_N1);

myeeg_prep_wk = pop_loadset(fullfile(derivpath, 'NS_nap_preproc_v9', 'prep_data', 'DA_wakeEpNAP_PREP.set'));
myeeg_prep_wk = eeg_checkset(myeeg_prep_wk);
