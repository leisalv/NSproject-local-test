...
% Epoch & save data
pop_saveset(myeeg_out, 'filename', 'DA_rest_PREP.set', 'filepath', myoutdata, 'version','7.3');

myeeg_epRs = pop_epoch(myeeg_out, {'myep'}, [0  30], 'epochinfo', 'yes');
pop_saveset(myeeg_epRs, 'filename', 'DA_restEp_PREP.set', 'filepath', myoutdata, 'version','7.3');
