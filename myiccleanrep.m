function myiccleanrep(EEG,reject,keep,classcomps,goodchannels,outpath)
...
myicplot(reject,class,cprob,EEG,goodchannels,outpath)

% Plot Retained components
myicplot(keep,class,cprob,EEG,goodchannels,outpath)
